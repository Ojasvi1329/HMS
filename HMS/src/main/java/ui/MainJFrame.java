...
public class MainJFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanelMainFrame.setBackground(new java.awt.Color(255, 204, 204));
        ...
        cmbBoxRole.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "System Admin", "Community Admin", "Hospital Admin", "Doctor", "Patient" }));
        ...
        jLabel1.setText("WELCOME TO HMS PAGE");
    ...
    private void btnLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoginActionPerformed
        ...
        if(userName.isEmpty() || password.length == 0) {
            ...
            if (role.equals("Sys Admin")
                && userName.equalsIgnoreCase("Ojasvi")
                ...
                && userName.equalsIgnoreCase("OjasviC")
                ...
                && userName.equalsIgnoreCase("OjasviH")
                && passwordString.equals("123")) {
